...
public sealed record SelectedItems(IReadOnlyList<int> Points, IReadOnlyList<Guid> Tracks, IReadOnlyList<Guid> Entries)
{
    /// <summary>Nothing selected but the edited track.</summary>
    public static readonly SelectedItems None = new([], [], []);
}
